...
const imported_logos = [
    ...
    IconGooglecloud, IconApacheairflow, IconKubernetes, IconPhp, IconJava,
    IconJenkins, IconPerl, IconJavascript, IconGithubactions, IconDjangorest,
    IconDockerWordmark, IconKubernetes
];
...
<template>
    <div>
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" v-else-if="name === 'Websocket'">
        ...
        <svg width="100px" height="100px" viewBox="0 0 256 204" version="1.1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" preserveAspectRatio="xMidYMid" v-else-if="name === 'Serverless'">
            <g>
                <path
